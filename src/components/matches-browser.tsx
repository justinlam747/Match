...
/**
 * Self-contained matches browser: loads the user's scored matches and renders
 * the filter controls + card grid + quick-view dialog. Embedded inline on the
 * dashboard below the setup/stats controls.
 */
export function MatchesBrowser({
  onLoaded,
}: {
  /** Reports the loaded match count up to the parent (for the stats bar). */
    ...
    return (
      <div className="text-center py-16 max-w-sm mx-auto">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Click <span className="font-medium text-foreground">Find matches</span> above to score
          companies against your resume.
        </p>
      </div>
    );
  }
