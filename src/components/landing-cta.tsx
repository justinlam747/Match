    ...
    <section id="how-it-works" className="px-10 md:px-16 lg:px-24 pb-28">
      <div className="max-w-[1400px] mx-auto">
        <ClipReveal from="bottom" duration={1}>
          <div className="bg-foreground text-background p-12 sm:p-16 lg:p-24 relative overflow-hidden">
            {/* Abstract decoration */}
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-10 items-start">
              ...
              <div className="lg:col-span-7 space-y-8">
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1]">
                  Set up your first
                  <br />
                  match <span className="inline-block w-12 h-12 bg-primary align-middle" />{" "}
                  in
                  <br />
                  minutes
                </h2>
                ...
                <Link href="/login">
                  <Button
                    size="lg"
                    className="h-14 px-10 text-sm font-semibold rounded-none bg-primary hover:bg-primary/90 mt-2"
                  >
                    Get started free
                  </Button>
                </Link>
              ...
              <div className="lg:col-span-5 space-y-5">
                {[
                  ...
                  },
                  {
                    step: "02",
                    title: "Get matched",
                    desc: "Scored against every YC company on 4 dimensions.",
                  },
                  {
                    step: "03",
                  ...
                  <div
                    key={item.step}
                    className="flex gap-5 items-start p-5 bg-white/[0.04] border border-white/[0.06]"
                    style={{ marginLeft: `${i * 12}px` }}
                  >
                    <div className="flex-shrink-0 w-12 h-12 bg-white/[0.08] flex items-center justify-center text-sm font-bold text-primary">
                      {item.step}
                    </div>
                    <div>
